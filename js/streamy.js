...
(function() {
    ...
    window.addEventListener('keydown', (e) => {
        ...
        console.log("[Streamy] D-Pad Key:", key, "| Active:", active.className || active.id || active.tagName);
