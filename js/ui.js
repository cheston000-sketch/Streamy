import { IMAGE_URL, BACKDROP_URL, fetchMusicChart, searchMusic, searchMusicSaavn } from './api.js?v=47';
import { MusicState, playTrack, saveMusicState } from './music.js?v=47';
